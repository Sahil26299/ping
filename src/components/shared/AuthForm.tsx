    ...
    <div className={layoutConfig.container.className}>
      <div className={layoutConfig.formContainer.className}>
        ...
        <div className={layoutConfig.brandingSection.className}>
          <div
            className={`${brandingConfig.logo.size} ${brandingConfig.logo.color} rounded-full mx-auto mb-4 flex items-center justify-center`}
          >
            <span
              className={`${brandingConfig.logo.textColor} ${brandingConfig.logo.textSize}`}
            >
          ...
          <p className="text-muted-foreground">
            {formConfig.submitButton.text?.toLowerCase() === "sign up"
              ? brandingConfig.subtitle.signup
              : brandingConfig.subtitle.login}
          </p>
        </div>
                ...
                {formConfig.options.rememberMe.enabled && (
                  <label className="flex items-center space-x-2 cursor-pointer">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {formConfig.options.rememberMe.label}
                    </span>
                  </label>
                )}
                {formConfig.options.forgotPassword.enabled && (
